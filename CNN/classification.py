...
# Datasets
parser.add_argument('-d', '--data', default=r'./monkey/', type=str)
...
parser.add_argument('--train-batch', '-b', default=16, type=int, metavar='N',
                    help='train batchsize (default: 4)')
parser.add_argument('--test-batch', default=2, type=int, metavar='N',
                    help='test batchsize (default: 22)')
parser.add_argument('--lr', '--learning-rate', default=0.01, type=float,
                    metavar='LR', help='initial learning rate')
parser.add_argument('--drop', '--dropout', default=0.1, type=float,
                    metavar='Dropout', help='Dropout ratio')
parser.add_argument('--schedule', type=int, nargs='+', default=[4, 7, 10],
...
parser.add_argument('--cpu-only', dest='cpu_only', action='store_true',
                    help='use cpu for training only')
...
def main():
    ...
    if args.cpu_only:
        ...
        use_cuda = True
        print('Using {} GPUs for traing!'.format(torch.cuda.device_count()))
    ...
    # input_size = (model.input_size[1], model.input_size[2])
    input_size = (224, 224)
